...
namespace ImGui
{
	...
	IMGUI_API bool			ButtonColoured(const char* label, ImU32 colour, ImU32 buttonHovered, ImU32 buttonActive, const ImVec2& size = ImVec2(0, 0));
	IMGUI_API void			ModifyStyle(ImGuiCol index, const ImVec4 colour); //my function
